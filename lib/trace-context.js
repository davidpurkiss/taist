...
export function getContext() {
  ...
  // If no AsyncLocalStorage context, check for fallback correlation ID
  const correlationId = globalThis[TAIST_CORRELATION_KEY].current;
  return { depth: 0, traceId: null, parentId: null, id: null, correlationId };
}
